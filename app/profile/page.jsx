...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-[#050508] text-on-background font-body-main antialiased selection:bg-primary-container selection:text-on-primary-container">
      ...
      {/* Navbar */}
      <nav className="sticky top-0 z-50 flex items-center justify-between px-4 sm:px-6 py-4 border-b border-white/[0.06] bg-[#0d0d14]/80 backdrop-blur-xl max-w-7xl mx-auto">
        <div className="flex items-center gap-2.5 cursor-pointer">
          <div className="w-9 h-9 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-xl flex items-center justify-center text-lg"><button className="cursor-pointer" onClick={() => router.push("/dashboard")}>₹</button></div>
          <span className="font-semibold text-base"><button className="cursor-pointer" onClick={() => router.push("/dashboard")}>SpEndora </button> </span>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10 relative z-10">
        ...
        <div className="mb-10 animate-fade-up">
          <h1 className="font-h1 text-3xl sm:text-4xl md:text-h1 text-white mb-1.5">
            My Profile
          </h1>
        ...
        {/* ── Account Stats Card ── */}
        <div className="animate-fade-up glass-card bg-gradient-to-br from-blue-500/10 to-violet-500/10 border border-white/10 rounded-2xl p-7 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="bg-[#050508] border border-white/[0.08] rounded-xl p-4 text-center">
        ...
        <PlanUsageBar
          ...
          counts={{
            ...
            categories: user?._count?.categories || 0,
            budgets: user?._count?.budgets || 0,
          }}
        />

        {/* ── Update Name Card ── */}
        <div className="animate-fade-up glass-card bg-white/[0.04] border border-white/[0.08] rounded-2xl p-7 mb-6">
        ...
        {/* ── Appearance Card ── */}
        <div className="animate-fade-up glass-card bg-white/[0.04] border border-white/[0.08] rounded-2xl p-7">
